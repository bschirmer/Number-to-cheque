...
namespace AutoCheque.Models
{
    ...
    public static class ChequeConverter
    {

        public static string ConvertInputToNumberWords(double input)
        {
        ...
        private static string _convertLessThan1000(double number)
        {
            var n = (int)number;
